...
INSERT INTO place (
    ...
    (1, '1', 'A', 'HAUT',   'NORD', 15.00),
    (2, '2', 'A', 'HAUT',   'NORD', 15.00),
    (3, '1', 'B', 'MILIEU', 'NORD', 20.00),
    (4, '2', 'B', 'MILIEU', 'NORD', 20.00),
    (5, '1', 'C', 'BAS',    'SUD',  25.00),
    (6, '2', 'C', 'BAS',    'SUD',  25.00),
    (7, '1', 'D', 'MILIEU', 'SUD',  20.00),
    (8, '2', 'D', 'MILIEU', 'SUD',  20.00);
